...
#     NAME => q[blog]
#     NO_META => q[1]
#     PREREQ_PM => { Authen::Passphrase::BlowfishCrypt=>q[0], Catalyst::Action::RenderView=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Plugin::Static::Simple=>q[0], Catalyst::Runtime=>q[5.90114], Config::General=>q[0], DBIx::Class::PassphraseColumn=>q[0], ExtUtils::MakeMaker=>q[6.36], Moose=>q[0], Test::More=>q[0.88], namespace::autoclean=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
...
MAN1PODS = script/blog_cgi.pl \
	...
	script/blog_test.pl
MAN3PODS = lib/Blog/Schema/Result/Comment.pm \
...
pure_all :: $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_test.pl $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_test.pl \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_server.pl \
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>salamaashoush,,,</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Authen::Passphrase::BlowfishCrypt" />' >> $(DISTNAME).ppd
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=DBIx::Class::PassphraseColumn,0,Authen::Passphrase::BlowfishCrypt,0

installdeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --installdeps=DBIx::Class::PassphraseColumn,0,Authen::Passphrase::BlowfishCrypt,0

upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=DBIx::Class::PassphraseColumn,0,Authen::Passphrase::BlowfishCrypt,0,Test::More,0.88,Catalyst::Runtime,5.90114,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=DBIx::Class::PassphraseColumn,0,Authen::Passphrase::BlowfishCrypt,0,Test::More,0.88,Catalyst::Runtime,5.90114,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

listdeps ::
	@$(PERL) -le "print for @ARGV" DBIx::Class::PassphraseColumn Authen::Passphrase::BlowfishCrypt

listalldeps ::
	@$(PERL) -le "print for @ARGV" DBIx::Class::PassphraseColumn Authen::Passphrase::BlowfishCrypt Test::More Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General
